...
# %%
confirmedPerc = popul[popul.Date == max(popul.Date)][['State/UnionTerritory','ConfirmPerc']]
confirmedPerc.sort_values('State/UnionTerritory',inplace=True)


# %%
confirmedPerc.set_index('State/UnionTerritory',inplace=True)


# %%
confirmedPerc.drop(['Andaman and Nicobar Islands', 'Dadra and Nagar Haveli and Daman and Diu'],inplace=True)


# %%
confirmedPerc.reset_index(inplace=True)


# %%
confirmedPerc['ConfirmPerc'].dtype


# %%
country_cases['ConfirmPerc'] = confirmedPerc['ConfirmPerc']


# %%
country_cases['Confirmed'].corr(country_cases['ConfirmPerc'], method='spearman')

# %% [markdown]
# Yes there is positive some correlation between these two columns

# %%
country_cases.drop('index',axis=1,inplace=True)


# %%
# Using Pearson Correlation
plt.figure(figsize=(12,10))
cor = country_cases.corr()
